...
from eureka.command_decorator import EUREKA_COMMAND_IDENTIFIER
from eureka.models.command import Command
...
class CommandRegistry:
    ...
    def import_command_module(self, module_name: str) -> None:
        ...
        classes that are decorated with the `EUREKA_COMMAND_IDENTIFIER` attribute
        ...
        for attr_name in dir(module):
            ...
            if getattr(attr, EUREKA_COMMAND_IDENTIFIER, False):
