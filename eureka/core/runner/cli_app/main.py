...
from eureka.core.agent import AgentSettings, SimpleAgent
from eureka.core.runner.client_lib.logging import (
    configure_root_logger,
    get_client_logger,
)
from eureka.core.runner.client_lib.parser import (
...
async def run_eureka(user_configuration: dict):
    """Run the Eureka CLI client."""
    ...
    if not agent_workspace:  # We don't have an agent yet.
        ...
        user_objective = click.prompt("What do you want Eureka to do?")
