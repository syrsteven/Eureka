...
from eureka.core.runner.cli_web_app.server.api import task_handler
...
def server(port: int) -> None:
    """Run the Eureka runner httpserver."""
    click.echo("Running Eureka runner httpserver...")
