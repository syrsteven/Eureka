...
from eureka.core.configuration import SystemConfiguration, UserConfigurable

if TYPE_CHECKING:
    from eureka.core.ability import Ability, AbilityRegistry
    from eureka.core.memory import Memory
...
class PluginStorageFormat(str, enum.Enum):
    ...
    # Eureka_PLUGIN_SERVICE = "Eureka_plugin_service"
...
#     storage_route='Eureka_plugins.twitter.SendTwitterMessage'
# )
# Workspace example
# PluginLocation(
...
#     storage_format='git',
#     Exact format TBD.
#     storage_route='https://github.com/gravelBridge/Eureka-WolframAlpha/blob/main/Eureka-wolframalpha/wolfram_alpha.py'
# )
# PyPI
# PluginLocation(
#     storage_format='pypi',
