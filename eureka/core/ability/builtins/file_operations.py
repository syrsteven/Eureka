...
from eureka.core.ability.base import Ability, AbilityConfiguration
from eureka.core.ability.schema import AbilityResult, ContentType, Knowledge
from eureka.core.plugin.simple import PluginLocation, PluginStorageFormat
...
class ReadFile(Ability):
    default_configuration = AbilityConfiguration(
        location=PluginLocation(
            ...
            storage_route="eureka.core.ability.builtins.ReadFile",
        ),
...
class WriteFile(Ability):
    default_configuration = AbilityConfiguration(
        location=PluginLocation(
            storage_format=PluginStorageFormat.INSTALLED_PACKAGE,
            storage_route="eureka.core.ability.builtins.WriteFile",
        ),
        packages_required=["unstructured"],
        workspace_required=True,
    )
