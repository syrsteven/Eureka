...
from eureka.core.ability import (
    AbilityRegistrySettings,
    AbilityResult,
    SimpleAbilityRegistry,
)
from eureka.core.agent.base import Agent
from eureka.core.configuration import Configurable, SystemConfiguration, SystemSettings
from eureka.core.memory import MemorySettings, SimpleMemory
from eureka.core.planning import PlannerSettings, SimplePlanner, Task, TaskStatus
from eureka.core.plugin.simple import (
    PluginLocation,
    PluginStorageFormat,
    SimplePluginService,
)
        ...
        configuration=AgentConfiguration(
            ...
            systems=AgentSystems(
                ability_registry=PluginLocation(
                    ...
                    storage_route="eureka.core.ability.SimpleAbilityRegistry",
                ),
                memory=PluginLocation(
                    storage_format=PluginStorageFormat.INSTALLED_PACKAGE,
                    storage_route="eureka.core.memory.SimpleMemory",
                ),
                openai_provider=PluginLocation(
                    storage_format=PluginStorageFormat.INSTALLED_PACKAGE,
                    storage_route=(
                        "eureka.core.resource.model_providers.OpenAIProvider"
                    ),
                ),
                planning=PluginLocation(
                    storage_format=PluginStorageFormat.INSTALLED_PACKAGE,
                    storage_route="eureka.core.planning.SimplePlanner",
                ),
                workspace=PluginLocation(
                    storage_format=PluginStorageFormat.INSTALLED_PACKAGE,
                    storage_route="eureka.core.workspace.SimpleWorkspace",
                ),
            ),
        ),
    )
