...
from eureka.agents.features.context import ContextMixin, get_agent_context
...
from eureka.models.context_item import FileContextItem, FolderContextItem
...
if TYPE_CHECKING:
    from eureka.agents import Agent, BaseAgent
