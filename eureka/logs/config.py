...
from eureka.core.runner.client_lib.logging import BelowLevelFilter

from .formatters import EurekaFormatter, StructuredLoggingFormatter
...
def configure_logging(
    ...
    if log_format in (LogFormatName.DEBUG, LogFormatName.SIMPLE):
        ...
        console_formatter = EurekaFormatter(console_format_template)
    else:
    ...
    if log_file_format is not None:
        if level < logging.ERROR:
            ...
            file_output_formatter = EurekaFormatter(
        ...
        error_log_handler.setFormatter(
            EurekaFormatter(DEBUG_LOG_FORMAT, no_color=True)
        )
