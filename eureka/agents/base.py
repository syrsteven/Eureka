...
if TYPE_CHECKING:
    ...
    from eureka.core.prompting.base import PromptStrategy
    ...
    from eureka.models.command_registry import CommandRegistry

from eureka.agents.utils.prompt_scratchpad import PromptScratchpad
from eureka.config import ConfigBuilder
from eureka.config.ai_directives import AIDirectives
from eureka.config.ai_profile import AIProfile
from eureka.core.configuration import (
    Configurable,
    SystemConfiguration,
    SystemSettings,
    UserConfigurable,
)
from eureka.core.prompting.schema import (
    ChatMessage,
    ChatPrompt,
...
from eureka.core.runner.client_lib.logging.helpers import dump_prompt
from eureka.file_storage.base import FileStorage
from eureka.llm.providers.openai import get_openai_command_specs
from eureka.models.action_history import ActionResult, EpisodicActionHistory
from eureka.prompts.prompt import DEFAULT_TRIGGERING_PROMPT
...
class BaseAgentSettings(SystemSettings):
    ...
    ai_profile: AIProfile = Field(default_factory=lambda: AIProfile(ai_name="Eureka"))
...
class BaseAgent(Configurable[BaseAgentSettings], ABC):
    """Base class for all Eureka agent classes."""
