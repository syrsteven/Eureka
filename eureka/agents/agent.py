...
from eureka.core.configuration import Configurable
from eureka.core.prompting import ChatPrompt
from eureka.core.resource.model_providers import (
...
from eureka.logs.log_cycle import (
...
from eureka.models.command import CommandOutput
from eureka.models.context_item import ContextItem
...
COMMANDS_ALLOWED_TO_REPEAT = {"finish", "open_file", "open_folder"}
...
class Agent(
    ...
    """Eureka's primary Agent; uses one-shot prompting."""
    ...
    def parse_and_process_response(
        ...
        if (
            command_name not in COMMANDS_ALLOWED_TO_REPEAT
            and self.event_history.matches_last_command(command_name, arguments)
        ):
    ...
    async def execute(
        ...
        if command_name == "human_feedback":
            ...
            # with open('/data/yuanrui/agent.txt','w') as f:
            #     f.write(str(result))    
            # print("result:",str(result))
            print("result_tlength:",result_tlength)
