...
if TYPE_CHECKING:
    ...
    from eureka.models.action_history import Episode

from eureka.agents.utils.exceptions import InvalidAgentResponseError
from eureka.config import AIDirectives, AIProfile
from eureka.core.configuration.schema import SystemConfiguration, UserConfigurable
from eureka.core.prompting import (
    ChatPrompt,
...
from eureka.core.utils.json_utils import extract_dict_from_json, json_loads
from eureka.prompts.utils import format_numbered_list, indent
