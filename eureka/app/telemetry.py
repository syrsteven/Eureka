...
def setup_telemetry() -> None:# sentry
    if os.getenv("TELEMETRY_OPT_IN") is None:
        set_env_config_value("TELEMETRY_OPT_IN", "false")
...
# This means Eureka will send diagnostic data to the core development team when something
