...
from eureka.agents.agent import Agent, AgentConfiguration, AgentSettings
from eureka.app.main import _configure_openai_provider
from eureka.config import AIProfile, Config, ConfigBuilder
from eureka.core.resource.model_providers import ChatModelProvider, OpenAIProvider
from eureka.file_storage.local import (
    FileStorage,
    FileStorageConfiguration,
    LocalFileStorage,
)
from eureka.llm.api_manager import ApiManager
from eureka.logs.config import configure_logging
...
def agent(
    ...
    agent_settings = AgentSettings(
        ...
        agent_id=f"Eureka-test-agent-{str(uuid.uuid4())[:8]}",
